                                ...
                                <div class="body">
									...
									<div class="row" style="margin: 0px 3px 0px 3px;">
										<div class="col-md-3 valid-info">
											...
											<input type="text" class="form-control" name="minPerson" value="{{$product->minPerson}}" required />
										</div>
										<div class="col-md-3 valid-info">
											<h5>Maximum Person*</h5>
											<input type="text" class="form-control" name="maxPerson" value="{{$product->maxPerson}}" required />    
										</div>
									</div>
									<div class="row" style="margin: 0px 3px 0px 3px;">
										<div class="col-md-6 valid-info">
											<h5>Starting Point/Gathering Point(where should your costumer meet you)?*</h5>
											<input type="text" id="pac-input" class="form-control" name="meetingPoint" placeholder="Start typing an address" value="{{$product->meetingPointAddress}}"  required />
									...
									<div class="row" style="margin: 0px 3px 0px 3px;">
										<div class="col-md-6 valid-info">
											...
											<textarea rows="4" name="meetingPointNotes" class="form-control no-resize">{{$product->meetingPointNote}}</textarea>
										</div>
									</div>
									<div class="row" style="margin: 0px 3px 0px 3px;">
										<div class="col-md-6 valid-info">
											<h5>PIC Name*</h5>
											<input type="text" class="form-control" name="PICName" value="{{$product->PICName}}" required>
										</div>
									</div>
									<div class="row" style="margin: 0px 3px 0px 3px;">
										<div class="col-md-6 valid-info">
									...
									<div class="row" style="margin: 0px 3px 0px 3px;">
										<div class="col-md-6 valid-info">
											...
											<textarea rows="4" name="termCondition" class="form-control no-resize" required>{{$product->termCondition}}</textarea>
										</div>
									</div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <div class="body">
                                    <div class="row valid-info" style="margin: 0px 3px 0px 3px;">
										...
										<div class="col-md-3">
											<input name="scheduleType" type="radio" id="1d" class="radio-col-deep-orange" value="1" sel="1" required disabled/>
											<label for="1d">Multiple days</label>
										</div>
										<div class="col-md-3" style="margin: 5px 3px 0px 3px;">
											<input name="scheduleType" type="radio" id="2d" class="radio-col-deep-orange" value="2" disabled />
											<label for="2d">A couple of hours</label>
										</div>
										<div class="col-md-3" style="margin: 5px 3px 0px 3px;">
											<input name="scheduleType" type="radio" id="3d" class="radio-col-deep-orange" value="3" disabled/>
											<label for="3d">One day full</label>
										</div>
									</div>
									<div id="schedule_body">
                                        @foreach($product->schedules as $key=>$schedule)
										<div class="row" id="dinamic_schedule" style="margin: 0px 3px 0px 3px;">
											<div class="col-md-3 valid-info" id="scheduleCol1">
												<h5>Start date*</h5>
												<input type="text" id="scheduleField1" class="form-control" name="schedule[{{$key}}][startDate]" placeholder="YYYY-MM-DD" value="{{$schedule->startDate}}" required/>
											</div>
											<div class="col-md-3 valid-info" id="scheduleCol2">
												<h5>End date*</h5>
												<input type="text" id="scheduleField2" class="form-control" name="schedule[{{$key}}][endDate]" placeholder="YYYY-MM-DD" value="{{$schedule->endDate}}" required readonly/>
											</div>
											<div class="col-md-2 valid-info" id="scheduleCol3" style="display: none">
												<h5>Start hours *</h5>
												<input type="text" id="scheduleField3" class="form-control" name="schedule[{{$key}}][startHours]" placeholder="HH:mm:ss" value="{{$schedule->startHours}}"  required/>
											</div>
											<div class="col-md-2 valid-info" id="scheduleCol4" style="display: none">
												<h5>End hours*</h5>
												<input type="text" id="scheduleField4" class="form-control" name="schedule[{{$key}}][endHours]" placeholder="HH:mm:ss" value="{{$schedule->endHours}}"  required/>
											</div>
											<div class="col-md-3 valid-info" id="scheduleCol5">
												<h5>Max.Booking Date*</h5>
												<input type="text" id="scheduleField5" class="form-control" name="schedule[{{$key}}][maxBookingDate]" placeholder="YYYY-MM-DD" value="{{$schedule->minBookingDateTime}}"  required/>
											</div>
											<div class="col-md-1 valid-info" id="scheduleCol6">
												<h5>Max.Booking*</h5>
												<input type="text" id="scheduleField6" class="form-control" name="schedule[{{$key}}][maximumGroup]" value="{{$schedule->maximumBooking}}"  required/>
											</div>
											<div class="col-md-1" id="del_button" style="padding-top:25px "><button type="button" id="delete_schedule" class="btn btn-danger waves-effect"><i class="material-icons">clear</i></button></div>
                                        </div>
                                        @endforeach
										...
										<div class="col-md-3 valid-info">
                                            ...
                                            <script>
                                                $(document).ready(function(){
                                                    $("select[name='productCategory']").find("option[value='{{$destination->provinceId}}']").attr('selected','selected');
                                                });
                                            </script>
										</div>
										<div class="col-md-3 valid-info">
                    ...
                    <div class="col-md-12" id="activity_detail">
                        ...
                        <fieldset>
                            ...
                            <div class="card">
                                ...
                                <div id="itineraryGenerate">
                                    @foreach($product->itineraries as $key=>$itinerary)
                                    <div class="body" id="itinerary_list" style="display: none">
                                        <h5>{{$itinerary->day}}</h5>
                                        <input id="field_itinerary_input1" name="itinerary[{{$key}}][day]" value="{{$itinerary->day}}" type="hidden" />
                                        <div class="row" id="itinerary_row">
                                            <div class="col-md-2 valid-info" id="field_itinerary1">
                                                <h5>Start time*</h5>
                                                <input id="field_itinerary_input2" type="text" name="itinerary[{{$key}}][day]" class="form-control" placeholder="HH:mm:ss" values="{{$itinerary->startHours}}" required />
                                            </div>
                                            <div class="col-md-2 valid-info" id="field_itinerary2">
                                                <h5>End time*</h5>
                                                <input id="field_itinerary_input3" type="text" name="itinerary[{{$key}}][day]" class="form-control" placeholder="HH:mm:ss" values="{{$itinerary->endHours}}" required />
                                            </div>
                                            <div class="col-md-6 valid-info" id="field_itinerary7">
                                                <h5>Description</h5>
                                                <textarea id="field_itinerary_input7" rows="6" name="itinerary[{{$key}}][day]" class="form-control" placeholder="Description" required>{{$itinerary ->description}}</textarea>
                                            </div>
                                            <div class="col-md-1" style="padding-top:35px"></div>
                                        </div>
                                        <div id="clone_dinamic_itinerary"></div>   
...
@section('footer')
    ...
    <!-- MASK -->
        <script>
            ...
            $("#scheduleField3,#scheduleField4,#field_itinerary_input2,#field_itinerary_input3").mask('00:00:00');
        </script>
    <!-- Tour Type -->
        <script>
            $(document).ready(function() {
    ...
    <!-- Date Picker-->
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $(this).closest("#dinamic_schedule").find("#scheduleField2").val(picker.endDate.format('YYYY-MM-DD'));
                });
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#add_more_schedule").click(function(){
                    ...
                    $("div#dinamic_schedule:first").clone().appendTo("#clone_dinamic_schedule").addClass("row dinamic_schedule"+i);
                    $(".dinamic_schedule"+i+" .col-md-1#del_button").append('<button type="button" id="delete_schedule" class="btn btn-danger waves-effect"><i class="material-icons">clear</i></button>');
                    ...
                    $(".dinamic_schedule"+i+" #scheduleField3").attr("name","schedule["+i+"][startHours]").mask('00:00:00');
            ...
            $(document).ready(function() {
                ...
                $("#nav").find("#next").click(function(){
                    ...
                    if(val == 1){
                            $("#itineraryGenerate").empty();
                            $("#itinerary_list").show();
                            var end = new Date($("input[name='schedule[0][endDate]']").val());
                            var start = new Date($("input[name='schedule[0][startDate]']").val()); 
    ...
    <!-- EDIT -->
        <script>
            $(document).ready(function(){
                // PRODUCT CATEGGORY
                    $("select[name='productCategory']").find("option:contains('{{$product->productType}}'')").attr('selected','selected');
                // PRODUCT TYPE
                    $("select[name='productType']").find("option:contains('{{$product->productCategory}}'')").attr('selected','selected');
                ...
                // SCHEDULE
                    @if($product->schedules[0]->scheduleType == 'Multiple Days')
                        $("input[name='scheduleType'][value='1']").removeAttr("disabled").attr("checked","");
                    ...
                    @elseif($product->schedules[0]->scheduleType == 'Couple of Hours')
                        $("input[name='scheduleType'][value='2']").removeAttr("disabled").attr("checked","");
                    ...
                    @else
                        $("input[name='scheduleType'][value='3']").removeAttr("disabled").attr("checked","");
                    ...
                    @endif
                    $("div#dinamic_schedule:first").find("button#delete_schedule").remove();
                // DESTINATION
            });
        </script>
@endsection
