		...
		<div class="row">
			<div class="col-md-4 form-field">
				...
				<div class="row" id="form_register">
					<div class="alert alert-danger" id="notif" style="display: none"></div>
					...
					@csrf
						...
						<div class="col-md-12" style="font-size: 16px;text-align: right;">
							<h5><a href="{{ url('/password/reset') }}">Forgot password?</a></h5>
						</div>
						<div class="col-md-12">
							<button type="submit" class="btn-block">Sign In</button>
						</div>
						<div class="col-md-12">
							<p>Interested to become partner? <a href="{{ url('/register') }}">Join Us Now</a></p>
						</div>
					</form>
				</div>
			</div>
 ...
 <script type="text/javascript">
	$(document).ready(function(){
		...
		if(stat == 1){
			...
			$("#notif").append("<strong>"+info+"</strong>");
			$('#segment').hide();
		}
	});
 </script>
