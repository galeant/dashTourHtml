	  		...
	  		<div class="col-md-3" style="text-align:right;">
	  			<div class="" style="display:flex;margin-left:100px;">
						<div class="visible-md visible-lg" style="margin-top: 30px">
							<button type="button" class="button-rg-top"><a href="#" id="draft" style="text-decoration:none; color:white;">Save As Draft</a></button>
				 		</div>
						<div class="visible-md visible-lg" style="margin-top: 30px">
			...
			<div class="col-md-8">
				...
				@csrf
					...
					<!-- HEADER FORM -->
						...
						<div class="row">
							<div class="col-md-12" id="header-form-1" style="margin-bottom: 10px;">
								<h3 style="line-height:1.5em;">Hello, {{ $data->fullName}} !</h3>
								<h5 style="line-height:1.5em;">Before you start, let's complete these mandatory information first. Once completed, you will be asked to submit a product sample. After that, please wait for further notification from us. We will have to review your information first before we can activate your access</h5><br>
							...
							<div class="col-md-12" id="header-form-2" style="margin-bottom: 10px;display: none">
								<h3 style="line-height:1.5em;">Submit Product Sample</h3>
								<h5 style="line-height:1.5em;"><b>Important:</b></h5>
								<h5 style="line-height:1.5em;">As part of our business policy, we require you to submit one product of yours for our perusal before we can activate your account.</h5>
								<h5 style="line-height:1.5em;">You may complete this form right away or save it as draft to complete it later.</h5>
							</div>
					<!-- CONTENT -->
						<!-- COMPANY -->
										...
										<div class="col-md-10 mg-top-10px">
											...
											<!-- BETA TEST IMAGE -->
												<div class="col-md-12" id="preview">
													<div class="col-md-7 valid-info">
														<img class="img-responsive" src="{{ asset($data->company->bankAccountScanUrl)}}" >
													</div>
													<div class="col-md-4">
														<button id="change" type="button" class="btn-block submit">Change</button>					
													</div>
												</div>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-12" id="akta" style="margin-top: 10px;display: none" >
											<div class="row">
												...
												<!-- BETA TEST IMAGE -->
													<div class="col-md-8" id="preview" style="margin-top: 10px">
														<div class="col-md-7">
															<img class="img-responsive" src="{{ asset($data->company->aktaUrl)}}" >
														</div>
														<div class="col-md-4">
															<button id="change" type="button" class="btn-block submit">Change</button>					
														</div>
										...
										<div class="col-md-12" id="siup" style="display: none">
											<div class="row">
												...
												<!-- BETA TEST IMAGE -->
													<div class="col-md-8" id="preview" style="margin-top: 20px;">
														<div class="col-md-7">
															<img class="img-responsive" src="{{ asset($data->company->siupUrl)}}" >
														</div>
														<div class="col-md-4">
															<button id="change" type="button" class="btn-block submit">Change</button>					
														</div>
										...
										<div class="col-md-12" id="npwp">
											<div class="row">
												...
												<!-- BETA TEST IMAGE -->
													<div class="col-md-8" id="preview" style="margin-top: 10px">
														<div class="col-md-7">
															<img class="img-responsive" src="{{ asset($data->company->npwpUrl)}}" >
														</div>
														<div class="col-md-4">
															<button id="change" type="button" class="btn-block submit">Change</button>					
														</div>
										...
										<div class="col-md-12" id="ktp">
											<div class="row">
												...
												<!-- BETA TEST IMAGE -->
													<div class="col-md-8" id="preview" style="margin-top: 10px">
														<div class="col-md-7">
															<img class="img-responsive" src="{{ asset($data->company->ktpUrl)}}" >
														</div>
														<div class="col-md-4">
															<button id="change" type="button" class="btn-block submit">Change</button>					
														</div>
										...
										<div class="col-md-12" id="evi" style="display: none">
											<div class="row">
												...
												<!-- BETA TEST IMAGE -->
													<div class="col-md-8" id="preview" style="margin-top: 10px">
														<div class="col-md-7">
															<img class="img-responsive" src="{{ asset($data->company->evidanceUrl)}}" >
														</div>
														<div class="col-md-4">
															<button id="change" type="button" class="btn-block submit">Change</button>					
														</div>
						...
						<section class="step-2"> 
							<div class="col-md-12" style="margin-top: 10px">
								...
								<div class="row">
									<div class="col-md-6 valid-info">
										...
										<input type="hidden" id="geo-lat" class="form-control" name="meetingPointLongitudeLatitude" />    
							...
							<div class="col-md-12">
								...
								<div class="row valid-info">
									...
									<div class="col-md-3">
										<input name="scheduleType" type="radio" id="1d" class="radio-col-deep-orange" value="1" required checked/>
					...
					<!-- PRICE -->
						<section class="step-4">
							<div class="col-md-12">
								...
								<div class="row valid-info">
									<div class="col-md-4">
										<input name="priceKurs" type="radio" id="1p" class="radio-col-deep-orange" value="1" required/>
								...
								<div class="row" id="price_row">
									...
									<div id="price_fix">
										<div class="col-md-3 valid-info" id="price_idr">
											...
											<input type="text" id="idr" name="price[0][IDR]" class="form-control" placeholder="Price IDR" required />     
										</div>
										<div class="col-md-3 valid-info" id="price_usd" style="display: none">
											<h5>Price USD</h5>
											<input type="text" id="usd" name="price[0][USD]" class="form-control" placeholder="Price USD" required />     
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12">
								...
								<div class="row valid-info">
									<div class="col-md-3">
										<input name="cancellationType" type="radio" id="1c" class="radio-col-deep-orange" value="1" required/>
						...
						<section class="step-5">
							...
							<div class="col-md-12 valid-info" style="margin-top:20px">
								...
								<div class="row" id="embed" style="display: w;margin-bottom: 10px">
									<div class="col-md-6" >
										<input type="url" class="form-control" name="videoUrl[]" placeholder="URL Video ex.httt://www.youtube.com" required />
									</div>
									<div class="col-md-3">                            
					...
					<!-- MOBILE BUTTON DISPLAY -->
						<div class="col-md-6 visible-sm visible-xs" style="margin-top: 30px">
							<button type="button" class="btn-block"><a href="#" id="draft" style="text-decoration:none;"> Save As Draft</a></button>
						</div>
						<div class="col-md-6 visible-sm visible-xs" style="margin-top: 30px">
							<button type="button" class="btn-block"><a href="{{url('/logout')}}" style="text-decoration:none;">Logout</a></button>
						</div>
					</div>
				</form>
			</div>
...
<!-- ORIGINAL-->
	<script>
		$(document).ready(function(){
			...
			// FOR VIEW (PROTOTYPE)
				var status = "{{ $data->company->status}}";
				var booksys = "{{ $data->company->companyBookSystem}}";
				if(status == "decline"){
					$(".col-md-12 #input").hide();
				}else{
					$(".col-md-12 #preview").hide();
				}
		...
		$(document).ready(function() {
			$("#productType").change(function(){
				if($(this).val()=="Open Group"){
					...
					$("#scheduleCol6").find("h5").text("Max.Person*");
					$("#scheduleField6")
					...
					$("#scheduleCol6").find("h5").text("Max.Booking*");
					$("#scheduleField6")
						.removeAttr("readonly")
						.val(null);
				}
      ...
      $(document).ready(function () {
        ...
        $("input[name='scheduleType']:radio").change(function () {
          ...
          if(type == 1){
            ...
            $("#scheduleCol1, #scheduleCol2, #scheduleCol5, #scheduleCol6").show();
            $("#scheduleCol3, #scheduleCol4").removeAttr("required").hide();
            $("#clone_dinamic_schedule").empty();
            $("#dinamic_schedule input").val(null);
          }else if(type == 2){
			$("#scheduleCol1").find("h5").text("Date*");
            $("#scheduleCol1, #scheduleCol3, #scheduleCol4, #scheduleCol6").show();
            $("#scheduleCol2, #scheduleCol5").removeAttr("required").hide();
            $("#clone_dinamic_schedule").empty();
            $("#dinamic_schedule input").val(null);
          }else{
			$("#scheduleCol1").find("h5").text("Date*");  
            $("#scheduleCol2, #scheduleCol3, #scheduleCol4").removeAttr("required").hide();;
        ...
        $("#add_more_schedule").click(function(){
            ...
            $(".dinamic_schedule"+i+" input").val(null)
        });
		...
		$(document).ready(function() {
			...
			$("input[name='scheduleType']:radio").change(function(){
				...
				if(val == 1){
					...
					{ 
						$("#itinerary_list").clone().appendTo("#itineraryGenerate").addClass("body itinerary_list"+i);   
						$(".itinerary_list"+i+" h5").append("Days "+(i+1)); 
						$(".itinerary_list"+i+" #field_itinerary_input1").attr("name","itinerary["+i+"][day]").val((i+1));
						$(".itinerary_list"+i+" #field_itinerary_input2").attr("name","itinerary["+i+"][list][0][startTime]").bootstrapMaterialDatePicker({
							weekStart: 0, format: 'HH:mm',  date: false
						}).on('change', function(e, date){
